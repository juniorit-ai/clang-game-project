...
/* 
  TODO:
  A store offers a 5% discount on purchases over $50, and a 10% discount on purchases over $100. 
  Write a program that asks the user for the amount of their purchase and applies the appropriate discount.
*/